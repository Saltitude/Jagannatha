...
public class SC_UI_OngletContainer : MonoBehaviour
{
    ...
    public void EndScreenUnzoom()
    {
        CamAnimator.speed = 1000;
        DisplayOut();
        MoveOut();
        WeaponOut();
        //camHub.transform.position = camHubTransformStart.position;
        //camHub.transform.rotation = camHubTransformStart.rotation;
    }
